...
class MC4WP_Log_Table extends WP_List_Table {
	...
	public function __construct() {
		...
		parent::__construct(
			array(
				'singular' => __( 'Subscriber Log', 'mailchimp-for-wp' ),
				'plural'   => __( 'Subscriber Logs', 'mailchimp-for-wp' ),
				'ajax'     => false
			)
		);
	...
	public function get_columns() {
		...
		$columns = array(
			...
			'merge_vars'  => __( 'Data', 'mailchimp-for-wp' ),
	...
	private function get_log_items() {
		...
		if ( isset( $_GET['view'] ) ) {
			$args['signup_method'] = sanitize_text_field( $_GET['view'] );
		}
