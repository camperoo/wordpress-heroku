	...
	*/
	(function() {
		'use strict';
			...
			// vars
			var $notice = $("#mc4wp-form-settings p.mc4wp-notice");	
			var $lists = $("#mc4wp-lists :input");
			var $inputDoubleOptin = $("#mc4wp-optional-settings input[name='mc4wp_form[double_optin]']");
			var $inputUpdateExisting = $('#mc4wp-optional-settings input[name="mc4wp_form[update_existing]"]');
