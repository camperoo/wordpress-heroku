	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="entry-image">
			...
			<?php foreach($gallery as $image) : ?>
				...
				<?php $alt =  esc_attr($post->post_title); ?>
				<li><img src="<?php echo $image; ?>" alt="<?php echo $alt; ?>" /></li>
			<?php endforeach; ?>
			</ul>
		</div>
		<?php endif; ?>
	...
	<div class="blog-item">
		...
		<div class="post-thumbnail">
			...
			<?php foreach($gallery as $image) : ?>
				...
				<?php $the_image = wp_get_attachment_image_src( $image, 'item-size' ); ?> 
				<?php $alt =  esc_attr($post->post_title); ?>
				<li><a href="<?php the_permalink(); ?>"><img src="<?php echo $image; ?>" alt="<?php echo $alt; ?>" /></a></li>
