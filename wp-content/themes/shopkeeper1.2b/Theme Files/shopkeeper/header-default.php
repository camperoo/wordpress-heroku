            ...
            <div class="site-header-wrapper" style="max-width:<?php echo esc_html($header_max_width_style); ?>">
                ...
                <div class="site-tools <?php echo esc_html($site_tools_padding_class); ?>">
                    <ul>
                        ...
                        <li class="offcanvas-menu-button <?php if ( (isset($shopkeeper_theme_options['main_header_off_canvas'])) && ($shopkeeper_theme_options['main_header_off_canvas'] == "0") ) : ?>hide-for-xlarge-up<?php endif; ?>">
                            <a class="tools_button">
                ...
                <nav class="show-for-xlarge-up main-navigation default-navigation <?php if ( (isset($shopkeeper_theme_options['main_header_navigation_position_header_1'])) ) echo esc_html($shopkeeper_theme_options['main_header_navigation_position_header_1']); ?>" role="navigation">                    
                    <?php 
