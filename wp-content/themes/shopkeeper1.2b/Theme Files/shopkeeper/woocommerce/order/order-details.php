...
<div class="row">
	<div class="large-12 large-centered columns">
        ...
        <header>
			<h2 class="my_address_title">
			<?php _e( 'Customer details', 'woocommerce' ); ?></h3>
		</header>
            ...
            <div class="shipping_billing_wrapper">
				<div class="row">
                    ...
                    <div class="medium-6 columns">
						<?php endif; ?>
						<header class="title">
							<h3 class="billing_shipping_address_title"><?php _e( 'Billing Address', 'woocommerce' ); ?></h3>
						</header>
						<address>
							<?php
                    ...
                    <div class="medium-6 columns">
                        ...
                        <header class="title">
							<h3 class="billing_shipping_address_title"><?php _e( 'Shipping Address', 'woocommerce' ); ?></h3>
						</header>
