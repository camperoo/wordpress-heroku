...
function shopkeeper_custom_styles() {	
	...
	<style>
		...
		{
			color: rgba(<?php echo hex2rgb($shopkeeper_theme_options['body_color']); ?>,0.4);
		}
		
		.required
		{
			color: rgba(<?php echo hex2rgb($shopkeeper_theme_options['body_color']); ?>,0.4) !important;
		}
		...
		{
			color: rgba(<?php echo hex2rgb($shopkeeper_theme_options['body_color']); ?>,0.55);
		}
		
		.products a.button.add_to_cart_button.loading
		{
			color: rgba(<?php echo hex2rgb($shopkeeper_theme_options['body_color']); ?>,0.55) !important;
		}
		
		.add_to_cart_inline .amount
		{
			color: rgba(<?php echo hex2rgb($shopkeeper_theme_options['body_color']); ?>,0.8);
		}
		...
		#coupon_code
		{
			border-color: rgba(<?php echo hex2rgb($shopkeeper_theme_options['body_color']); ?>,0.1);
		}
		...
		{
			border-color: rgba(<?php echo hex2rgb($shopkeeper_theme_options['body_color']); ?>,0.15);
		}
		...
		{
			border-bottom-color: rgba(<?php echo hex2rgb($shopkeeper_theme_options['body_color']); ?>,0.15);
		}
		...
		{
			border-top-color: rgba(<?php echo hex2rgb($shopkeeper_theme_options['body_color']); ?>,0.15);
		}
		...
		.shop_table.cart tr
		{
			border-bottom-color: rgba(<?php echo hex2rgb($shopkeeper_theme_options['body_color']); ?>,0.1);
		}
		...
		.order-info
		{
			background: rgba(<?php echo hex2rgb($shopkeeper_theme_options['body_color']); ?>,0.05);
		}
		
		.custom_border:before,
		.custom_border:after
		{
			background-image: radial-gradient(closest-side, transparent 9px, rgba(<?php echo hex2rgb($shopkeeper_theme_options['body_color']); ?>,0.05) 100%);
		}
		
		.cart-buttons .update_and_checkout .update_cart
		{
			background: rgba(<?php echo hex2rgb($shopkeeper_theme_options['body_color']); ?>,0.55) !important;
		}
		
		.cart-buttons .update_and_checkout .update_cart:hover
		{
			background: rgba(<?php echo hex2rgb($shopkeeper_theme_options['body_color']); ?>,0.44) !important;
		}
		
		.comments_section
		{
			background-color: rgba(<?php echo hex2rgb($shopkeeper_theme_options['body_color']); ?>,0.01) !important;
		}
		...
		{
			color: rgba(<?php echo hex2rgb($shopkeeper_theme_options['headings_color']); ?>,0.35);
		}
		...
		{
			color: rgba(<?php echo hex2rgb($shopkeeper_theme_options['headings_color']); ?>,0.45);
		}
		...
		.url:hover
		{
			color:  rgba(<?php echo hex2rgb($shopkeeper_theme_options['main_color']); ?>,0.8) !important;
		}
		
		.product-title-link:hover
		{
			color:  rgba(<?php echo hex2rgb($shopkeeper_theme_options['headings_color']); ?>,0.8);
		}
		...
		{
			background: rgba(<?php echo hex2rgb($shopkeeper_theme_options['main_color']); ?>,0.8) !important;
		}
		...
		<?php if ( (isset($shopkeeper_theme_options['custom_css'])) && (trim($shopkeeper_theme_options['custom_css']) != "" ) ) : ?>
			<?php echo esc_html($shopkeeper_theme_options['custom_css']) ?>
		<?php endif; ?>
