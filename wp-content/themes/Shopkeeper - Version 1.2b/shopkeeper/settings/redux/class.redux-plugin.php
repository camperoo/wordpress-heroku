        ...
        class ReduxFrameworkPlugin {
            ...
            public function plugin_metalinks( $links, $file ) {
                if ( strpos( $file, 'redux-framework.php' ) !== false && is_plugin_active( $file ) ) {
                    ...
                    $new_links = array(
                        '<a href="" target="_blank">' . __( 'Repo', 'redux-framework' ) . '</a>',
                        '<a href="" target="_blank">' . __( 'Generator', 'redux-framework' ) . '</a>',
                        '<a href="" target="_blank">' . __( 'Issues', 'redux-framework' ) . '</a>',
                        '<a href="" target="_blank">' . __( 'Documentation', 'redux-framework' ) . '</a>',
                    );
